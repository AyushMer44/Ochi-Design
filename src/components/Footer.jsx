...
function Footer() {
    return (
        <div className='w-full flex gap-5 h-screen p-20 font-["Founders_Grotesk_X-Condensed"]'>
            <div className='w-1/2 h-full flex flex-col justify-between]'>
                <div className='heading'>
                    <h1 className='text-[8vw] uppercase font-semibold leading-none tracking-tighter -mb-5'>Eye-</h1>
                    <h1 className='text-[8vw] uppercase font-semibold leading-none tracking-tighter -mb-5'>Opening</h1>
                </div>
            ...
            <div className='w-1/2'>
                <h1 className='text-[6vw] uppercase font-semibold leading-none tracking-tighter -mb-5'>Presentations
                </h1>
